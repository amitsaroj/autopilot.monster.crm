...
export class NotificationService {
   ...
   */
  async sendPostCallFollowUp(tenantId: string, to: string, leadName: string, summary: string) {
    ...
    try {
      await this.whatsappService.sendTextMessage(tenantId, to, message, wabaId);
      return true;
    } catch (err) {
