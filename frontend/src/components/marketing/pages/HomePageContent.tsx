...
const features = [
  {
    icon: Users,
    title: 'Smart CRM',
    desc: 'AI-scored leads, drag-and-drop pipelines, and 360° contact intelligence.',
  ...
  },
  {
    icon: Sparkles,
    title: 'AI Agents',
    desc: 'Autonomous GPT-powered agents that qualify, nurture, and close deals 24/7.',
  ...
  },
  {
    icon: Phone,
    title: 'Voice AI',
    desc: 'Sub-second latency AI calling with real-time transcription and sentiment analysis.',
  ...
  },
  {
    icon: MessageSquare,
    title: 'WhatsApp OS',
    desc: 'Shared team inbox, broadcast campaigns, and visual no-code flow builder.',
  ...
  },
  {
    ...
    desc: 'Drag-and-drop automation with triggers, conditions, delays, and multi-channel actions.',
  ...
  },
  {
    ...
    desc: 'Real-time ARR tracking, pipeline forecasting, and AI-driven revenue insights.',
    color: 'from-teal-500 to-cyan-400',
    href: '/product/analytics',
  },
  {
    icon: Zap,
    title: 'Bulk AI Calling',
    desc: 'Launch parallel outbound campaigns at scale with autonomous AI agents.',
  ...
  },
  {
    icon: Sparkles,
    title: 'Agentic Apps',
    desc: 'Custom autonomous apps built for complex reasoning and workflow execution.',
  ...
  },
  {
    icon: Zap,
    title: 'n8n & Zapier',
    desc: 'Deep integrations across your entire stack using leading automation tools.',
  ...
  },
  {
    icon: Globe,
    title: 'Web & App Dev',
    desc: 'Premium development services for high-performance digital products.',
  ...
  },
  {
    ...
    desc: 'Optimized WordPress and Shopify stores built for scale and speed.',
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          <motion.div initial="hidden" animate="visible" custom={0} variants={fadeUp}>
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-gray-200 dark:border-white/[0.08] bg-gray-50 dark:bg-white/[0.03] text-sm font-medium text-gray-600 dark:text-gray-400 mb-8 backdrop-blur-sm">
              <Zap className="w-4 h-4 text-indigo-500 dark:text-indigo-400" aria-hidden="true" />
          ...
          >
            <div className="flex -space-x-2" aria-hidden="true">
              {[...Array(5)].map((_, i) => (
                <div
                  key={i}
                  className="w-8 h-8 rounded-full border-2 border-white dark:border-[#0b0f19] bg-gradient-to-br from-indigo-400 to-purple-500 flex items-center justify-center text-[10px] font-bold text-white shadow-lg"
                >
        ...
        <div
          className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-white dark:from-[#0b0f19] to-transparent z-20"
          aria-hidden="true"
        />
      </section>

      <section aria-labelledby="features-heading" className="relative py-32 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <span className="text-xs font-bold uppercase tracking-widest text-indigo-500 dark:text-indigo-400 mb-4 block">
              Everything You Need
            </span>
            <h2
              id="features-heading"
            ...
            <p className="text-lg text-gray-500 max-w-xl mx-auto">
              Replace 10 disconnected tools with one unified AI OS that works together seamlessly.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, i) => (
              ...
              >
                <Link
                  href={feature.href}
                  className="group relative block bg-gray-50 dark:bg-white/[0.03] border border-gray-200 dark:border-white/[0.06] rounded-2xl p-8 hover:bg-gray-100 dark:hover:bg-white/[0.06] transition-all hover:border-gray-300 dark:hover:border-white/[0.12] hover:shadow-2xl hover:shadow-indigo-500/5 hover:-translate-y-1 h-full"
                >
                  <div
                    className={`w-12 h-12 rounded-xl bg-gradient-to-br ${feature.color} flex items-center justify-center mb-6 shadow-lg shadow-black/20`}
                  >
          ...
          <div className="text-center mt-12">
            <Link
              href="/features"
              className="text-indigo-500 hover:text-indigo-400 font-medium inline-flex items-center gap-2"
            >
      ...
      <section aria-labelledby="cta-heading" className="relative py-32 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            >
              Ready to put revenue
              <br />
              on autopilot?
            </h2>
            <p className="text-lg text-gray-500 dark:text-gray-400 mb-10 max-w-lg mx-auto">
              Join thousands of teams using AutopilotMonster to close more deals, faster — with AI
              doing the heavy lifting.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/register"
                className="group px-8 py-4 text-base font-semibold text-white bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl shadow-2xl shadow-indigo-500/25 hover:shadow-indigo-500/40 transition-all hover:scale-[1.02] flex items-center gap-2"
              >
                Get Started Free{' '}
                <ArrowRight
                  className="w-4 h-4 group-hover:translate-x-1 transition-transform"
