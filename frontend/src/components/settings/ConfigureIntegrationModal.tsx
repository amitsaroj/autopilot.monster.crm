            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-[10px] text-muted-foreground mt-1 flex items-center gap-1">
                  <Info className="w-3 h-3" /> Overrides platform-wide OpenAI key for your
                  workspace.
                </p>
              </div>
              <div>
      ...
      default:
        return (
          <p className="text-sm text-muted-foreground italic">
            No specialized configuration available for this integration yet.
          </p>
        );
    }
  };
      ...
      <div className="bg-card w-full max-w-lg border border-border rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="px-6 py-4 bg-muted/30 border-t border-border">
          <div className="flex items-start gap-2 text-xs text-muted-foreground leading-relaxed">
            ...
            <p>
              Configuring these keys will disconnect this workspace from the platform-wide global
              credentials and use your specific provider billing.
            </p>
          </div>
        </div>
      </div>
