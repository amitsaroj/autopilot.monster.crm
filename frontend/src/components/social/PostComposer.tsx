  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <div className="absolute bottom-4 right-4 flex items-center gap-2">
                <button className="p-2 hover:bg-white rounded-lg text-gray-400 transition shadow-sm">
      ...
      <div className="hidden lg:flex flex-col gap-6">
        <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 px-2 block">
          Live Preview: {previewPlatform}
        </label>
        ...
        <div className="bg-emerald-50 dark:bg-emerald-900/10 p-6 rounded-[24px] border border-emerald-100 dark:border-emerald-800/20">
          <p className="text-xs font-medium text-emerald-800 dark:text-emerald-400 leading-relaxed">
            <strong>Pro Tip:</strong> Posts with at least one image get 2.3x more engagement on
            LinkedIn.
          </p>
        </div>
      </div>
