  ...
  return (
    <div className="px-4 py-3 shadow-xl rounded-xl bg-white dark:bg-[#1f2937] border-2 border-orange-500/50 min-w-[200px]">
      ...
      <Handle
        ...
        className="w-3 h-3 bg-orange-500 border-2 border-white dark:border-[#1f2937]"
      />
      ...
      <div className="mt-4 flex justify-between">
        <div className="relative">
          <Handle
            ...
            id="yes"
            className="w-3 h-3 bg-green-500 border-2 border-white dark:border-[#1f2937]"
            style={{ left: '30%' }}
          />
        ...
        <div className="relative">
          <Handle
            ...
            position={Position.Bottom}
            id="no"
            className="w-3 h-3 bg-red-500 border-2 border-white dark:border-[#1f2937]"
            style={{ left: '70%' }}
          />
