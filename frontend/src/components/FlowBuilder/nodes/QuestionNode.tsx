...
export const QuestionNode = memo(({ data }: NodeProps) => {
  return (
    <div className="px-4 py-3 shadow-xl rounded-xl bg-white dark:bg-[#1f2937] border-2 border-purple-500/50 min-w-[200px]">
