      ...
      <div className="w-full max-w-2xl px-6 relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-1000">
        <div className="mb-12 text-center space-y-4">
          ...
          <p className="text-gray-400 max-w-lg mx-auto font-medium leading-relaxed">
            Configure your workspace identity artifacts and administrative footprint to launch the
            CRM infrastructure.
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-3">
                ...
                <div className="relative flex items-center">
                  ...
                  <span className="absolute right-5 text-gray-600 font-mono text-sm leading-none pt-1">
                    .autopilot.crm
                  </span>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <option value="SaaS" className="bg-[#0b0f19]">
                    Software & SaaS
                  </option>
                  <option value="E-commerce" className="bg-[#0b0f19]">
                    E-commerce
                  </option>
                  <option value="Agency" className="bg-[#0b0f19]">
                    Digital Agency
                  </option>
                  <option value="Enterprise" className="bg-[#0b0f19]">
                    Enterprise Services
                  </option>
                  <option value="Other" className="bg-[#0b0f19]">
                    Other
                  </option>
                </select>
              </div>
