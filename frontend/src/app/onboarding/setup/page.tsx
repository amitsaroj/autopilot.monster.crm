        ...
        <div className="relative z-10 space-y-10">
          ...
          <div>
            ...
            <p className="text-gray-500 text-[10px] font-black uppercase tracking-widest">
              Onboarding Phase 01: Core Matrix Configuration
            </p>
          </div>
            ...
            <div className="space-y-6 animate-in slide-in-from-right-4 duration-500">
              <div className="space-y-2">
                <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1">
                  Entity Designation (Company Name)
                </label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-white/[0.03] border border-white/5 rounded-3xl pl-16 pr-6 py-5 text-sm text-white outline-none focus:border-indigo-500/40 shadow-inner"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full bg-white/[0.03] border border-white/5 rounded-3xl pl-16 pr-6 py-5 text-sm text-emerald-400 font-bold outline-none appearance-none cursor-pointer"
                  >
                    <option value="TECHNOLOGY" className="bg-[#0b0f19]">
                      Information Technology
                    </option>
                    <option value="FINANCE" className="bg-[#0b0f19]">
                      Fiscal Services
                    </option>
                    <option value="HEALTHCARE" className="bg-[#0b0f19]">
                      Bioscience & Health
                    </option>
                    <option value="RETAIL" className="bg-[#0b0f19]">
                      Consumer Goods
                    </option>
                  </select>
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full bg-white/[0.03] border border-white/5 rounded-3xl pl-16 pr-6 py-5 text-sm text-emerald-400 font-bold outline-none appearance-none cursor-pointer"
                  >
                    <option value="1-10" className="bg-[#0b0f19]">
                      1 - 10 Operatives
                    </option>
                    <option value="11-50" className="bg-[#0b0f19]">
                      11 - 50 Operatives
                    </option>
                    <option value="51-200" className="bg-[#0b0f19]">
                      51 - 200 Operatives
                    </option>
                    <option value="200+" className="bg-[#0b0f19]">
                      Enterprise Vector (200+)
                    </option>
                  </select>
                </div>
              </div>
          ...
          <div className="pt-10 flex gap-4">
            {step > 1 && (
              <button
                ...
                className="px-8 py-5 rounded-3xl bg-white/5 border border-white/10 text-gray-400 text-[10px] font-black uppercase tracking-widest hover:bg-white/10 transition-all"
              >
                Previous
              </button>
            )}
            ...
            >
              {loading ? (
                <Loader2 className="w-4 h-4 animate-spin font-black text-xl" />
              ) : (
                <>
