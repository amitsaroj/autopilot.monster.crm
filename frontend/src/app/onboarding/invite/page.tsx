        ...
        <div className="relative z-10 space-y-10">
          ...
          <div>
            ...
            <p className="text-gray-500 text-[10px] font-black uppercase tracking-widest">
              Onboarding Phase 02: Team Lattice Initialization
            </p>
          </div>
          ...
          <div className="space-y-6 max-h-[400px] pr-2 overflow-y-auto scrollbar-none">
            {invites.map((invite, idx) => (
              <div
                key={idx}
                className="flex gap-4 items-start animate-in slide-in-from-left-4 duration-500 group"
              >
                ...
                <div className="w-32">
                  ...
                  >
                    <option value="USER" className="bg-[#0b0f19]">
                      User
                    </option>
          ...
          >
            <Plus className="w-5 h-5 group-hover:rotate-90 transition-transform" /> Add Another
            Operative
          </button>
