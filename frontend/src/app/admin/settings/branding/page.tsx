      ...
      <div className="flex justify-between items-center bg-white/[0.02] p-8 rounded-[40px] border border-white/[0.05] backdrop-blur-md">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1 font-bold uppercase tracking-widest">
            Master configuration of tenant visual identity and white-labeling
          </p>
        </div>
        <button
          onClick={handleSave}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                ...
                <div className="aspect-video rounded-[32px] bg-white/[0.02] border-2 border-dashed border-white/5 flex flex-col items-center justify-center group/upload cursor-pointer hover:border-indigo-500/20 transition-all">
                  ...
                  <p className="mt-4 text-[10px] font-black text-gray-600 uppercase tracking-widest group-hover/upload:text-indigo-400">
                    Transmit Artifact
                  </p>
                  <p className="text-[9px] text-gray-700 mt-1 uppercase font-bold">
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center gap-6 p-8 rounded-[32px] bg-indigo-500/5 border border-indigo-500/10 backdrop-blur-xl">
                ...
                <div>
                  ...
                  <p className="text-[9px] text-gray-500 font-bold leading-relaxed uppercase tracking-tighter">
                    Remove all "Autopilot Monster" signatures from client-facing portals, emails,
                    and system logs.
                  </p>
                </div>
                <div
                ...
                >
                  <div
                    className={`w-6 h-6 rounded-full bg-white shadow-xl transition-all ${formData.whiteLabel ? 'translate-x-8' : 'translate-x-0'}`}
                  />
                </div>
              </div>
            </div>
