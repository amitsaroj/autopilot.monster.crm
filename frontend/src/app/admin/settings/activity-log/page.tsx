    ...
    <div className="space-y-10 animate-in fade-in duration-700 pb-20 text-sans">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1 uppercase tracking-widest font-bold">
            Monitor Administrative Dispatches, Policy Divergences & Systemic Integrity
          </p>
        </div>
      ...
      <div className="space-y-4">
        {logs.map((log) => (
          <div
            key={log.id}
            className="p-6 rounded-[32px] bg-white/[0.02] border border-white/[0.05] hover:border-indigo-500/20 transition-all group flex flex-col md:flex-row items-center gap-8 relative overflow-hidden"
          >
            ...
            <div className="flex items-center gap-6 flex-1 min-w-0">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-[10px] text-gray-600 font-medium uppercase tracking-tight flex items-center gap-2">
                  ...
                  {log.user?.name || 'Automated Dispatch'}
            ...
            <div className="flex items-center gap-10 shrink-0 text-right">
              <div className="hidden lg:block">
                <p className="text-[9px] text-gray-700 font-black uppercase tracking-widest mb-0.5">
                  Entity Node
                </p>
                <p className="text-[10px] text-gray-500 font-mono italic uppercase">
                  {log.entityId?.substring(0, 12) || 'UNIVERSAL'}
                </p>
              </div>
              <div>
          ...
          <div className="p-24 text-center space-y-8 bg-white/[0.01] border border-dashed border-white/10 rounded-[60px] transform scale-95 opacity-80">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-600 max-w-sm mx-auto leading-relaxed">
                The audit ledger is currently empty. Administrative actions and systemic dispatches
                will propagate to this feed in real-time.
              </p>
            </div>
            <button
              onClick={fetchLogs}
              className="px-10 py-4 bg-indigo-500 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-indigo-400 transition-all shadow-2xl shadow-indigo-500/40"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        <div className="p-10 rounded-[60px] bg-white/[0.02] border border-white/[0.05] flex flex-col md:flex-row items-center gap-10 group relative overflow-hidden">
          ...
          <div className="space-y-3 relative">
            ...
            <p className="text-sm text-gray-500 font-medium leading-relaxed max-w-sm">
              Utilize platform-wide integrity checks to verify audit persistence. Detect structural
              divergences in your workspace action artifacts automatically.
            </p>
          </div>
        </div>
        <div className="p-10 rounded-[60px] bg-[#0b0f19] border border-white/[0.05] flex flex-col md:flex-row items-center gap-10 group relative overflow-hidden">
          ...
          <div className="space-y-3 relative">
            ...
            <p className="text-sm text-gray-500 font-medium leading-relaxed max-w-sm">
              Monitor unauthorized administrative dispatches. Identify policy non-compliance
              artifacts across your workspace lattice via real-time forensic scanning.
            </p>
          </div>
        </div>
      </div>
