  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="p-3.5 rounded-xl bg-white/[0.02] border border-white/[0.05] flex items-center gap-3 focus-within:border-indigo-500/30 transition-all">
        ...
        <input
          type="text"
          placeholder="Search documents, contacts, deals..."
          value={search}
            ...
            {filtered.map((doc) => {
              ...
              return (
                <tr key={doc.id} className="group hover:bg-white/[0.02] transition-colors">
                  ...
                  <td className="px-5 py-4">
                    <span
                      className={`text-[10px] font-black uppercase tracking-widest px-2 py-0.5 rounded-full border ${colorClass.split(' ')[0]} ${colorClass.split(' ')[1]} border-current/20`}
                    >
                      {docType}
                    </span>
                  </td>
