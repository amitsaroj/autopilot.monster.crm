    ...
    <div className="space-y-10 animate-in fade-in duration-700 pb-20">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1 uppercase tracking-widest font-bold">
            Orchestrate Notes, Meeting Records & Knowledge Persistence
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="p-4 rounded-2xl bg-indigo-500/5 border border-indigo-500/20 flex items-center justify-between group cursor-pointer hover:bg-indigo-500/10 transition-all">
          <span className="text-[10px] text-indigo-400 font-black uppercase tracking-widest leading-none text-center">
            Export Wiki
          </span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {notes.map((note) => (
          <div
            key={note.id}
            className="p-10 rounded-[40px] bg-white/[0.02] border border-white/[0.05] hover:border-indigo-500/20 transition-all group flex flex-col justify-between relative overflow-hidden h-[400px]"
          >
            ...
            <div>
              ...
              <h3 className="text-xl font-black text-white group-hover:text-indigo-400 transition-colors uppercase tracking-tight mb-4 min-h-[56px] line-clamp-2">
                {note.title || 'Untitled Knowledge Artifact'}
              </h3>
              <p className="text-sm text-gray-500 leading-relaxed line-clamp-4 font-medium mb-8 italic opacity-60">
                "
                {note.content ||
                  'System-generated internal artifact recorded for workspace intelligence.'}
                "
              </p>
            </div>
            ...
            <div className="space-y-6 pt-6 border-t border-white/5">
              <div className="space-y-2">
                {note.contact && (
                  <div className="flex items-center gap-2 px-1 text-[10px] text-gray-600 font-bold uppercase tracking-widest leading-none">
                    <User className="w-3.5 h-3.5 text-indigo-500 opacity-40 shrink-0" />{' '}
                    {note.contact.firstName} {note.contact.lastName}
                  </div>
                )}
                {note.deal && (
                  <div className="flex items-center gap-2 px-1 text-[10px] text-gray-600 font-bold uppercase tracking-widest leading-none">
                    <Target className="w-3.5 h-3.5 text-emerald-500 opacity-40 shrink-0" />{' '}
                    {note.deal.name}
                  </div>
                )}
              </div>
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <button className="p-2.5 rounded-xl bg-white/[0.03] border border-white/5 text-gray-600 hover:text-white hover:bg-white/10 transition-all">
                    <Edit3 className="w-4 h-4" />
                  </button>
                  <button className="p-2.5 rounded-xl bg-white/[0.03] border border-white/5 text-gray-600 hover:text-red-400 transition-all">
        ...
        <div className="p-10 rounded-[40px] border border-dashed border-white/10 bg-indigo-500/[0.01] flex flex-col items-center justify-center text-center space-y-6 group cursor-pointer hover:border-indigo-500/30 transition-all h-[400px]">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 max-w-[200px] mx-auto leading-relaxed mt-2 uppercase tracking-widest font-black opacity-30">
              Knowledge Persistence Status: Scanning
            </p>
          </div>
        ...
        <div className="p-10 rounded-[40px] bg-white/[0.01] border border-white/[0.05] flex items-center gap-10 group relative overflow-hidden">
          ...
          <div className="space-y-2 relative">
            ...
            <p className="text-sm text-gray-500 font-medium leading-relaxed max-w-sm">
              Automatically categorize your internal artifacts using AI intelligence. Define global
              taxonomy dispatches to organize the workspace wiki with absolute precision.
            </p>
          </div>
        </div>
        <div className="p-10 rounded-[40px] bg-white/[0.01] border border-white/[0.05] flex items-center gap-10 group relative overflow-hidden">
          ...
          <div className="space-y-2 relative">
            ...
            <p className="text-sm text-gray-500 font-medium leading-relaxed max-w-sm">
              Orchestrate knowledge persistence across your entire workspace cluster. Synchronize
              internal artifacts with relevant contact and deal nodes automatically.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="p-10 rounded-[40px] border border-dashed border-white/10 bg-white/[0.01] flex flex-col md:flex-row items-center justify-between gap-10 group transition-all">
        <div className="flex items-center gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 max-w-xl font-medium tracking-tight">
              Internal artifacts are cryptographically isolated within your workspace node.
              Universal dispatches across clusters require explicit 'Administrative Overwrite'
              authentication.
            </p>
          </div>
        </div>
