      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1 uppercase tracking-widest font-bold">
            Orchestrate Multi-Channel Marketing & Dispatch Intelligence
          </p>
        </div>
                    ...
                    <div className="flex flex-col items-center gap-6 text-gray-700">
                      ...
                      <div className="space-y-1">
                        <p className="text-lg font-bold text-gray-500 font-sans uppercase tracking-widest">
                          No Outreach Artifacts Detected
                        </p>
                        <p className="text-xs text-gray-600 font-medium">
                          The workspace growth lattice is currently dormant. Provision your first
                          campaign dispatch to begin customer activation.
                        </p>
                      </div>
        ...
        <div className="p-10 rounded-[40px] bg-white/[0.02] border border-white/[0.05] space-y-8 group relative overflow-hidden flex flex-col justify-between">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm text-gray-500 leading-relaxed font-medium">
              Utilize platform-wide outreach forensics to identify high-performing dispatch windows.
              Analyze artifact sentiment pulse and click-through velocity across all active
              lattices.
            </p>
          </div>
          <div className="pt-8 border-t border-white/5 flex items-center justify-between">
            <div className="flex -space-x-3">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="w-10 h-10 rounded-full border-4 border-[#0b0f19] bg-white/5 flex items-center justify-center text-[10px] font-black text-gray-500"
                >
                  {i}
                </div>
              ))}
            </div>
            <span className="text-[10px] text-indigo-400 font-black uppercase tracking-widest italic animate-pulse">
              Analyzing Engagement Lattices...
            </span>
          </div>
        </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-[10px] text-white/60 font-black uppercase tracking-widest mt-1">
                Status: ROI Tracking Synchronized
              </p>
            </div>
          </div>
          <p className="text-sm text-white/80 leading-relaxed font-bold uppercase tracking-tight">
            Directly attribute revenue artifacts to specific Outreach dispatches. Track the entire
            fiscal lifecycle from lead-capture to final subscription.
          </p>
