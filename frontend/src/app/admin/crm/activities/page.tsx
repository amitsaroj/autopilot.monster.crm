    ...
    <div className="space-y-10 animate-in fade-in duration-700 pb-20">
        ...
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <span className="text-[10px] text-gray-600 font-mono tracking-tighter uppercase shrink-0 overflow-hidden text-ellipsis max-w-[200px]">
              Node: Engagement-History
            </span>
          </div>
          <h1 className="text-3xl font-black text-white tracking-tight text-sans">
            Activity Forensic Feed
          </h1>
          <p className="text-gray-500 text-sm mt-1 uppercase tracking-widest font-bold">
            Monitor Communications, Interactions & CRM Event Stream
          </p>
        </div>
      ...
      <div className="relative space-y-8 before:absolute before:inset-0 before:ml-10 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-white/[0.05] before:to-transparent">
        {activities.map((activity, idx) => (
          <div
            key={activity.id}
            className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group md:px-10"
          >
            {/* Timeline Dot */}
            ...
            <div className="w-[calc(100%-60px)] md:w-[calc(50%-40px)] p-8 rounded-[40px] bg-white/[0.02] border border-white/[0.05] group-hover:bg-white/[0.03] group-hover:border-indigo-500/10 transition-all relative overflow-hidden ml-auto md:ml-0 shadow-2xl">
              ...
              <h3 className="text-lg font-black text-white group-hover:text-indigo-400 transition-colors uppercase tracking-tight mb-2 truncate">
                {activity.subject}
              </h3>
              <p className="text-sm text-gray-500 leading-relaxed line-clamp-2 mb-6 font-medium">
                {activity.description ||
                  'System-generated interaction artifact recorded on the workspace communication lattice.'}
              </p>
              ...
              <div className="flex flex-wrap items-center gap-6 pt-6 border-t border-white/5">
                ...
                <div className="ml-auto flex items-center gap-2">
                  ...
                  <span className="text-[9px] text-gray-700 uppercase font-bold tracking-widest">
                    {activity.user?.name || 'Workspace Agent'}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="p-24 text-center space-y-8 bg-white/[0.01] border border-dashed border-white/10 rounded-[60px] mx-10 transform scale-95 opacity-80">
            ...
            <div className="space-y-2">
              <p className="text-xl font-bold text-gray-500 uppercase tracking-widest">
                Communication Lattice Silent
              </p>
              <p className="text-sm text-gray-600 max-w-sm mx-auto leading-relaxed">
                The engagement history is currently empty for this workspace cluster. Manual
                dispatches or AI interactions will propagate to this timeline in real-time.
              </p>
            </div>
            <button
              onClick={fetchActivities}
        ...
        <div className="flex items-center gap-8 relative">
          ...
          <div className="space-y-2">
            <h3 className="text-3xl font-black text-white uppercase tracking-tighter font-sans leading-none">
              Interaction Velocity Forensics
            </h3>
            <p className="text-sm text-gray-500 max-w-xl font-medium uppercase tracking-tighter opacity-60">
              Analyze Relationship Persistence & Dispatch Health artifacts
            </p>
          </div>
        </div>
