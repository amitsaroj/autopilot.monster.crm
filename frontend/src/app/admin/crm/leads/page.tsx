...
import { Plus, Search, Trash2, Edit2, Loader2, User, Mail, Phone, Building2, Target, Filter, ArrowRight } from "lucide-react";
    ...
    <div className="space-y-10 animate-in fade-in duration-700 pb-20">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
           ...
           <h1 className="text-3xl font-black text-white tracking-tight">Lead Intelligence Matrix</h1>
           <p className="text-gray-500 text-sm mt-1 uppercase tracking-widest font-bold">Monitor incoming vectors, acquisition sources, and conversion probabilities</p>
        </div>
