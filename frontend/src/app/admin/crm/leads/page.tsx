      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1 uppercase tracking-widest font-bold">
            Monitor incoming vectors, acquisition sources, and conversion probabilities
          </p>
        </div>
        <button
          onClick={openCreate}
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-white/5 bg-white/[0.01]">
                    <th className="p-6 text-[10px] font-black tracking-widest uppercase text-gray-500">
                      Vector Identity
                    </th>
                    <th className="p-6 text-[10px] font-black tracking-widest uppercase text-gray-500">
                      Source Artifact
                    ...
                    <th className="p-6 text-right text-[10px] font-black tracking-widest uppercase text-gray-500">
                      Actions
                    </th>
                  </tr>
                </thead>
                    ...
                    <tr key={lead.id} className="hover:bg-white/[0.01] transition-colors group">
                      ...
                      <td className="p-6 text-right space-x-2">
                        ...
                        <button
                          ...
                          className="p-2.5 rounded-xl text-gray-600 hover:text-white hover:bg-white/[0.05] transition-all"
                        >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in">
          <div className="w-full max-w-xl p-8 rounded-[40px] bg-[#0b0f19] border border-white/10 shadow-2xl animate-in zoom-in-95">
            <h2 className="text-2xl font-black text-white uppercase tracking-tighter mb-8 flex items-center gap-3">
              ...
              {editingId ? 'Reconfigure Vector' : 'Initialize Vector'}
            </h2>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="col-span-1 space-y-2">
                  ...
                  <select
                    ...
                    className="w-full bg-white/[0.03] border border-white/5 rounded-2xl px-5 py-4 text-sm text-white outline-none focus:border-emerald-500/40 appearance-none cursor-pointer"
                  >
                    <option value="Manual" className="bg-[#0b0f19]">
                      Manual Pulse
                    </option>
                    <option value="Webform" className="bg-[#0b0f19]">
                      Inbound Webform
                    </option>
                    <option value="API" className="bg-[#0b0f19]">
                      Nexus API
                    </option>
                    <option value="Referral" className="bg-[#0b0f19]">
                      Network Referral
                    </option>
                  </select>
                </div>
                <div className="col-span-1 space-y-2">
                  ...
                  >
                    ...
                    <option value="QUALIFIED" className="bg-[#0b0f19]">
                      Qualified Sequence
                    </option>
