        ...
        <div className="lg:col-span-2 p-10 rounded-[60px] bg-white/[0.01] border border-white/[0.05] relative overflow-hidden group">
          ...
          <div className="flex justify-between items-start mb-10">
            <div>
              <h3 className="text-2xl font-black text-white uppercase tracking-tighter font-sans leading-none">
                Resolution Velocity Forensics
              </h3>
              <p className="text-[10px] text-gray-600 font-black uppercase tracking-widest mt-2 px-1">
                Metric: Mean-Closing-Time
              </p>
            </div>
            <div className="flex gap-2">
              <span className="px-3 py-1 bg-white/5 rounded-lg text-[9px] font-black text-gray-500 uppercase">
                Live Loop
              </span>
            </div>
          </div>
          ...
          <div className="h-[300px] w-full flex items-end justify-between px-4 pb-2">
            {[60, 40, 80, 50, 90, 70, 85, 45, 75, 65, 95, 80].map((h, i) => (
              <div
                key={i}
                className="w-full max-w-[40px] flex flex-col items-center gap-4 group/bar"
              >
                <div
                  style={{ height: `${h}%` }}
                ...
                <span className="text-[8px] text-gray-700 font-black uppercase tracking-tighter">
                  NODE {i + 1}
                </span>
              </div>
            ))}
              ...
              {[
                ...
                <div key={mix.label} className="space-y-2">
                  ...
                  <div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
                    <div
                      className={`h-full ${mix.color} rounded-full`}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="p-10 rounded-[60px] bg-white/[0.02] border border-white/[0.05] space-y-6 group hover:bg-white/[0.03] transition-all relative overflow-hidden">
          ...
          <p className="text-sm text-gray-500 leading-relaxed font-medium">
            Monitor workspace CSAT artifacts in real-time. Analyze sentiment forensics across all
            resolved support dispatches to identify satisfaction trends.
          </p>
        </div>
        <div className="p-10 rounded-[60px] bg-white/[0.02] border border-white/[0.05] space-y-6 group hover:bg-white/[0.03] transition-all relative overflow-hidden">
          ...
          <p className="text-sm text-gray-500 leading-relaxed font-medium">
            Analyze individual agent performance artifacts. Track structural resolution velocity and
            engagement pulse per active administrative node.
          </p>
        </div>
        <div className="p-10 rounded-[60px] bg-indigo-600 space-y-10 shadow-2xl relative overflow-hidden group">
          ...
          <div className="flex items-center gap-6 relative">
            ...
            <div>
              ...
              <p className="text-[10px] text-white/60 font-black uppercase tracking-widest mt-2 px-1">
                Status: Resolution Optimized
              </p>
            </div>
          </div>
          <p className="text-xs text-white/90 leading-relaxed font-bold uppercase tracking-tight relative">
            Your workspace support resolution velocity is currently 14.2% faster than the
            platform-wide global cluster average.
          </p>
          <div className="flex gap-4 relative">
            ...
            <button className="flex-1 py-5 bg-white/10 hover:bg-white/20 backdrop-blur-md text-white rounded-3xl text-[10px] font-black uppercase tracking-widest border border-white/20 transition-all">
              Benchmarks
            </button>
          </div>
        </div>
