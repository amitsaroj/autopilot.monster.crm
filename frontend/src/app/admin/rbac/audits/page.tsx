            ...
            {filtered.map((event) => {
              ...
              return (
                <tr key={event.id} className="group hover:bg-white/[0.02] transition-colors">
                  ...
                  <td className="px-5 py-4 text-xs font-black text-white uppercase">
                    {event.action}
                  </td>
                  ...
                  <td className="px-5 py-4">
                    <span
                      className={`px-2 py-0.5 rounded-full border text-[9px] font-black uppercase tracking-widest flex items-center gap-1 w-fit ${outcome === 'ALLOWED' ? 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20' : 'bg-red-500/10 text-red-400 border-red-500/20'}`}
                    >
                      {outcome === 'ALLOWED' ? (
