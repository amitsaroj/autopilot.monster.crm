          ...
          >
            <div className="flex justify-between items-start mb-3">
              <div className="flex items-center gap-3">
                <span
                  className={`px-2.5 py-1 rounded-full border text-[10px] font-black uppercase tracking-widest ${CATEGORY_COLORS[prompt.category ?? 'GENERAL'] || CATEGORY_COLORS.GENERAL}`}
                >
                  {prompt.category}
                </span>
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="p-1.5 rounded-lg text-gray-600 hover:text-white hover:bg-white/[0.05] transition-all opacity-0 group-hover:opacity-100"
                >
            ...
            <h3 className="text-base font-black text-white group-hover:text-purple-400 transition-colors mb-1">
              {prompt.name}
            </h3>
            ...
            <div className="p-3 rounded-xl bg-white/[0.02] border border-white/[0.04] mb-4">
              <p className="text-[11px] text-gray-500 font-mono leading-relaxed line-clamp-2">
                {prompt.content}
              </p>
            </div>
