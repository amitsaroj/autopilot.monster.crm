          ...
          <div className="bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] rounded-2xl p-8 md:p-10 shadow-sm transition-all">
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                ...
                in order for our platform to operate, and we refer to these as "essential" or
                "strictly necessary" cookies. Other cookies also enable us to track and target the
                interests of our users to enhance the experience on our platform.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="p-5 rounded-2xl bg-gray-50 dark:bg-white/[0.02] border border-gray-100 dark:border-white/[0.04] transition-all hover:bg-gray-100 dark:hover:bg-white/[0.04]">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 m-0 leading-relaxed">
                    ...
                    certain functionality (like video) may become unavailable.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                To learn more about how to manage cookies on your browser, please visit the help
              ...
              <div className="flex flex-wrap gap-4 mt-4">
                {['Chrome', 'Firefox', 'Safari', 'Edge'].map((browser) => (
                  <a
                    key={browser}
                    href="#"
                    className="inline-flex items-center gap-1.5 text-xs font-semibold text-indigo-500 hover:text-indigo-600"
                  >
