      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-gray-500 dark:text-gray-400 max-w-xl mx-auto">
            We're looking for exceptional people to help us build the AI Revenue OS.
          </p>
        </motion.div>
          ...
          {[
            {
              ...
              desc: 'Work on bleeding-edge AI, voice, and automation technology.',
            },
            {
              icon: Globe,
              title: 'Remote Culture',
              desc: 'Work from anywhere in the world. Results matter, not hours.',
            },
            {
              icon: Heart,
              title: 'Great Benefits',
              desc: 'Competitive equity, unlimited PTO, and health coverage.',
            },
            {
              icon: Zap,
              title: 'Ship Fast',
              desc: 'Small autonomous teams that ship weekly. No red tape.',
            },
          ].map((v, i) => (
            <motion.div
              key={v.title}
        ...
        <div className="space-y-4">
          {openings.map((job, i) => (
            ...
            >
              <Link
                href="/contact"
                className="group flex items-center justify-between p-6 rounded-2xl bg-gray-50 dark:bg-white/[0.03] border border-gray-200 dark:border-white/[0.06] hover:bg-gray-100 dark:bg-white/[0.06] transition-all hover:border-gray-300 dark:border-white/[0.12]"
              >
                <div>
                  <h3 className="font-bold text-gray-900 dark:text-white group-hover:text-indigo-300 transition-colors">
                    {job.title}
                  </h3>
