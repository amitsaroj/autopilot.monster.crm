...
const features = [
  {
    icon: Globe,
    title: 'REST API',
    desc: 'Full CRUD API for every resource — contacts, deals, workflows, and more.',
  },
  {
    icon: Webhook,
    title: 'Webhooks',
    desc: 'Real-time event webhooks for CRM changes, AI completions, and workflow triggers.',
  },
  {
    icon: Code2,
    title: 'TypeScript SDK',
    desc: 'Official SDK for building custom integrations with full type safety.',
  },
  {
    icon: Blocks,
    title: 'Zapier-Style Connectors',
    desc: 'Pre-built connectors for 500+ apps without writing a single line of code.',
  },
  {
    icon: Key,
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-gray-500 dark:text-gray-400 max-w-2xl mx-auto mb-10">
            APIs, webhooks, SDKs, and 500+ pre-built connectors to integrate with your entire stack.
          </p>
          <Link
            href="/docs"
            className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-cyan-600 to-blue-600 text-gray-900 dark:text-white font-semibold rounded-xl shadow-2xl shadow-cyan-500/20 hover:scale-[1.02] transition-all"
          >
