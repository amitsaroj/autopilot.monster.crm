          ...
          <div className="bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] rounded-2xl p-8 md:p-10 shadow-sm transition-all">
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                This Service Level Agreement ("SLA") outlines our commitment to reliability and
                availability for the AutopilotMonster platform. We understand that our services are
                critical for your business operations, and we strive to provide a world-class
                experience with maximum uptime and responsiveness.
              </p>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                We guarantee that the AutopilotMonster platform will be available to you at least{' '}
                <strong className="text-gray-900 dark:text-white">99.9%</strong> of the time in any
                calendar month.
              </p>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full text-left text-sm">
                  <thead className="border-b dark:border-white/[0.06]">
                    <tr>
                      <th className="py-3 font-bold text-gray-900 dark:text-white">
                        Severity Level
                      </th>
                      <th className="py-3 font-bold text-gray-900 dark:text-white">
                        Response Time
            ...
            <section>
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                The SLA does not apply to (a) scheduled maintenance notified at least 24 hours in
                advance, (b) issues caused by your unauthorized actions or third-party software, or
                (c) factors outside our reasonable control (e.g., natural disasters, widespread
                internet outages).
              </p>
            </section>
          </div>
