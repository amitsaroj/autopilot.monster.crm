          ...
          {sections.map((section, i) => (
            ...
            >
              <Link href={section.href} className="group block">
                <div className="flex flex-col lg:flex-row items-start lg:items-center gap-8 p-8 rounded-2xl bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] hover:bg-white/[0.05] hover:border-gray-300 dark:hover:border-white/[0.12] transition-all hover:-translate-y-0.5">
                  <div
                  ...
                  <div className="flex-1">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2 group-hover:text-indigo-300 transition-colors">
                      {section.title}
                    </h2>
                  ...
                  <ArrowRight
                    className="w-5 h-5 text-gray-600 group-hover:text-gray-900 dark:text-white group-hover:translate-x-1 transition-all shrink-0"
                    aria-hidden="true"
                  />
                </div>
              </Link>
