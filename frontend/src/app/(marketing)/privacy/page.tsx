          ...
          <div className="bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] rounded-2xl p-8 md:p-10 shadow-sm transition-all">
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                At AutopilotMonster, we take your privacy seriously. This Privacy Policy explains
                how we collect, use, disclose, and safeguard your information when you use our
                AI-powered customer engagement platform. By accessing or using our services, you
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                We collect information that you provide directly to us, information from your use of
                ...
                <li className="flex gap-3 p-4 rounded-xl bg-gray-50 dark:bg-white/[0.02] border border-gray-100 dark:border-white/[0.04]">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-gray-500">
                      Name, email, company details, and authentication credentials.
                    </span>
                  </div>
                </li>
                <li className="flex gap-3 p-4 rounded-xl bg-gray-50 dark:bg-white/[0.02] border border-gray-100 dark:border-white/[0.04]">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-gray-500">
                      Call recordings, transcripts, WhatsApp messages, and AI interactions.
                    </span>
                  </div>
                </li>
                <li className="flex gap-3 p-4 rounded-xl bg-gray-50 dark:bg-white/[0.02] border border-gray-100 dark:border-white/[0.04]">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-gray-500">
                      IP addresses, browser types, device information, and interaction logs.
                    </span>
                  </div>
                </li>
                <li className="flex gap-3 p-4 rounded-xl bg-gray-50 dark:bg-white/[0.02] border border-gray-100 dark:border-white/[0.04]">
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">
                We implement robust security measures to protect your data, as detailed in our
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400 m-0">
                    <strong>Encryption at Rest:</strong> All sensitive data is encrypted using
                    AES-256-GCM.
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-1.5 h-1.5 rounded-full bg-indigo-500 mt-2 shrink-0" />
                  <p className="text-sm text-gray-600 dark:text-gray-400 m-0">
                    <strong>Encryption in Transit:</strong> Strict TLS 1.3 encryption for all data
                    moving between your browser and our servers.
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-1.5 h-1.5 rounded-full bg-indigo-500 mt-2 shrink-0" />
                  <p className="text-sm text-gray-600 dark:text-gray-400 m-0">
                    <strong>Access Control:</strong> Granular Role-Based Access Control (RBAC)
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                provide you with our services. If you wish to cancel your account or request that we
                no longer use your information to provide you services, please contact us. We will
