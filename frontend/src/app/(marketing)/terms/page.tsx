          ...
          <div className="bg-white dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.06] rounded-2xl p-8 md:p-10 shadow-sm transition-all">
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                By accessing or using AutopilotMonster, you agree to be bound by these Terms of
                Service. If you are using the service on behalf of an organization, you are agreeing
                to these terms for that organization and representing that you have the authority to
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
                To access features of the platform, you must register for an account. You are
                responsible for:
              </p>
            ...
            <section className="mb-12">
              ...
              <ul className="space-y-3 list-none p-0">
                ...
                <li className="flex items-start gap-3 text-sm text-gray-600 dark:text-gray-400">
                  ...
                  decipher any transmissions to or from the servers.
                </li>
                <li className="flex items-start gap-3 text-sm text-gray-600 dark:text-gray-400">
                  <AlertCircle className="w-4 h-4 text-red-500 mt-1 shrink-0" />
                  Taking any action that imposes an unreasonable or disproportionately large load on
                  our infrastructure (e.g., spamming, DoS).
                </li>
              </ul>
            </section>
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                Fees for our services are billed based on your selected plan. You are responsible
                for all taxes, and we will charge tax when required to do so. Our subscription fees
                are non-refundable except as required by law or as explicitly stated in our SLA.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                ...
                material changes by posting the new terms on this site. Your continued use of the
