        ...
        <div className="space-y-8">
          ...
          <div className="p-8 rounded-[40px] bg-indigo-500/10 border border-indigo-500/20 space-y-6 relative overflow-hidden group">
            ...
            <p className="text-xs text-gray-400 leading-relaxed font-medium">
              Modifying platform-wide metadata will propagate across all user interfaces and
              transactional messaging templates within 12 seconds.
            </p>
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 max-w-xl">
              Fine-grained system settings including DNS mapping, SMTP integration, and MFA policies
              are managed in specialized orchestration sections.
            </p>
          </div>
        </div>
