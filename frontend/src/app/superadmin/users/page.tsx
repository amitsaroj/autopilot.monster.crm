      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1 uppercase tracking-widest font-bold">
            Platform Personas Across All Clusters
          </p>
        </div>
                  ...
                  <td className="px-6 py-5">
                    <div className="flex flex-col gap-2 items-start">
                      ...
                      <div className="flex items-center gap-2">
                        <span
                          className={`px-1.5 py-0.5 rounded bg-black/40 border border-white/5 text-[9px] font-bold ${user.provider === 'local' ? 'text-gray-500' : 'text-blue-400'}`}
                        >
                          {user.provider.toUpperCase()}
                        </span>
                        {user.isMfaEnabled && <Lock className="w-3 h-3 text-emerald-500" />}
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-5">
                  ...
                  <td colSpan={5} className="px-6 py-20 text-center">
                    <div className="flex flex-col items-center gap-4 text-gray-600">
                      ...
                      <p className="text-sm font-medium">
                        No identities discovered matching your search
                      </p>
                      <button
                        onClick={() => setSearch('')}
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="space-y-2">
            ...
            <p className="text-sm text-gray-500 max-w-2xl leading-relaxed">
              Monitor active platform sessions, reset multi-factor authentication secrets, and
              perform global role-mapping overrides for emergency infrastructure access.
            </p>
          </div>
