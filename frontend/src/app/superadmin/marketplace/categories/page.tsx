  ...
  const [categories, setCategories] = useState<Category[]>([
    {
      ...
      name: 'Automation',
      slug: 'automation',
      description: 'Workflow and task automation artifacts.',
      icon: 'Zap',
      pluginCount: 124,
      status: 'ACTIVE',
    },
    {
      ...
      description: 'Neural network and LLM orchestration modules.',
      icon: 'Bot',
      pluginCount: 86,
      status: 'ACTIVE',
    },
    {
      ...
      name: 'Communication',
      slug: 'communication',
      description: 'Voice, SMS, and messaging dispatch layers.',
      icon: 'MessageSquare',
      pluginCount: 52,
      status: 'ACTIVE',
    },
    {
      ...
      name: 'Analytics',
      slug: 'analytics',
      description: 'Data visualization and business intelligence pulse.',
      icon: 'BarChart3',
      pluginCount: 31,
      status: 'ACTIVE',
    },
                  ...
                  <td className="px-8 py-6">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-gray-600 font-mono mt-0.5 line-clamp-1 max-w-[200px]">
                          {cat.description}
                        </p>
                      </div>
                    </div>
                  </td>
                  <td className="px-8 py-6">{getStatusBadge(cat.status)}</td>
                  ...
                  <td className="px-8 py-6">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-black text-white">
                        {cat.pluginCount}{' '}
                        <span className="text-[10px] text-gray-600 uppercase ml-1">Artifacts</span>
                      </span>
                    </div>
                  </td>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="p-8 rounded-[40px] bg-white/[0.02] border border-white/[0.05] space-y-6 group hover:bg-white/[0.03] transition-all">
          ...
          <p className="text-xs text-gray-500 leading-relaxed font-medium">
            Define nested taxonomy artifacts to allow for advanced marketplace discovery.
            Synchronize parent-child relationships across all platform clusters.
          </p>
        </div>
        <div className="p-8 rounded-[40px] bg-white/[0.02] border border-white/[0.05] space-y-6 group hover:bg-white/[0.03] transition-all">
          <div className="flex items-center gap-4">
          ...
          <p className="text-xs text-gray-500 leading-relaxed font-medium">
            Manage category icons, brand colors, and visual identifiers used in the tenant-facing
        ...
        <div className="p-8 rounded-[40px] bg-indigo-500 to-purple-600 text-white space-y-4 shadow-2xl shadow-indigo-500/20">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] text-white/60 font-black uppercase tracking-tighter">
                Master-Node Status: Certified
              </p>
            </div>
          </div>
          <p className="text-xs text-white/80 leading-relaxed font-medium">
            Taxonomy updates are broadcasted to all active clusters. Tenant-facing marketplaces will
            mirror these changes within seconds.
          </p>
        </div>
      </div>
    </div>
