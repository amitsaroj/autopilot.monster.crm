  ...
  const handleSave = async () => {
    try {
      await tenantSettingsService.updateSetting({
        key: 'inbox_auto_assign',
        value: autoAssign,
        group: 'inbox',
      });
      await tenantSettingsService.updateSetting({
        key: 'inbox_default_assignee',
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6 py-8">
      ...
      <div className="space-y-4 rounded-xl border border-border bg-card p-6">
        <div>
          <label className="text-sm font-medium">Auto-assign conversations</label>
          <select
            value={autoAssign}
        ...
        <div>
          <label className="text-sm font-medium">Default assignee ID</label>
          <input
            value={defaultAssignee}
