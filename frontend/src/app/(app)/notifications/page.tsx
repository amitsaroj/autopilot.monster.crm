...
const notifications = [
  {
    ...
    body: 'GlobalInc CRM Migration — $92k deal',
    time: '2m ago',
    read: false,
    type: 'deal',
  },
  {
    ...
    body: 'Follow up with TechCorp — 3:00 PM',
    time: '1h ago',
    read: false,
    type: 'task',
  },
  {
    ...
    body: 'Acme Corp scored 92 — marked as hot lead',
    time: '2h ago',
    read: true,
    type: 'lead',
  },
  {
    title: 'Invoice paid',
    body: 'StartupXYZ paid $4,800 — Invoice #1042',
    time: '4h ago',
    read: true,
    type: 'billing',
  },
  {
    ...
    body: 'Abandoned Chat Follow-up failed — 5 errors',
    time: '6h ago',
    read: true,
    type: 'error',
  },
  {
    ...
    body: 'Alex Kim joined the workspace',
    time: '1d ago',
    read: true,
    type: 'team',
  },
    ...
    <div className="max-w-3xl space-y-6 animate-fade-in">
      ...
      <div className="rounded-xl border border-border bg-card divide-y divide-border overflow-hidden">
        {notifications.map((n, i) => (
          <div
            key={i}
            className={`flex items-start gap-4 px-5 py-4 hover:bg-muted/30 transition-colors ${!n.read ? 'bg-[hsl(246,80%,60%)]/5' : ''}`}
          >
            {!n.read && (
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <span
                    className={`px-2 py-0.5 rounded-full text-xs font-medium ${typeColors[n.type]}`}
                  >
                    {n.type}
                  </span>
            ...
            <button className="p-1 rounded hover:bg-muted transition-colors mt-1">
