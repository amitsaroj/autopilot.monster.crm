    ...
    <div className="space-y-6 animate-in fade-in duration-500 max-w-3xl pb-20">
      ...
      <div>
        <h1 className="text-3xl font-black tracking-tight text-white uppercase">
          Provision Identity Node
        </h1>
        <p className="text-sm font-bold text-gray-500 uppercase tracking-widest mt-1">
          Deploy an invitation vector to a new subordinate
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="md:col-span-2 space-y-3">
            ...
            >
              ...
              <option value="TENANT_ADMIN" className="bg-[#0b0f19]">
                Tenant Administrative Layer
              </option>
              <option value="MANAGER" className="bg-[#0b0f19]">
                Group Manager Array
              </option>
            </select>
          </div>
