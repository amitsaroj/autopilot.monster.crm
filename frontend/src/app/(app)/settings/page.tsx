...
const settingsGroups = [
  {
    ...
    items: [
      { label: 'Profile', desc: 'Personal info and avatar', href: '/settings/profile', icon: User },
      {
        ...
        desc: 'MFA, sessions, login history',
        href: '/settings/password',
        icon: Shield,
      },
      {
        label: 'Notifications',
        desc: 'Email, push, in-app preferences',
    ...
    items: [
      {
        ...
        desc: 'Name, logo, branding, timezone',
        href: '/settings/workspace',
        icon: Building2,
      },
      {
        label: 'Members & Roles',
        desc: 'Invite users, manage roles',
        href: '/settings/users',
        icon: Users,
      },
      {
        label: 'SSO & Security',
        desc: 'SAML, IP allowlist, session policy',
        href: '/settings/workspace/sso',
        icon: Shield,
      },
    ],
  },
  {
    ...
    items: [
      {
        label: 'API Keys',
        desc: 'Manage access tokens and webhooks',
        href: '/settings/api',
        icon: Code,
      },
      {
        label: 'Integrations',
        desc: 'Connected apps and services',
        href: '/settings/integrations',
        icon: Plug,
      },
      {
        label: 'Data & Privacy',
        desc: 'Export, retention, GDPR',
        href: '/settings/data',
        icon: Database,
      },
    ],
