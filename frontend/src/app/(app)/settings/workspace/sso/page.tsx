    ...
    <div className="mx-auto max-w-2xl space-y-6 py-8">
      ...
      <div className="space-y-4 rounded-xl border border-border bg-card p-6">
        <div>
          ...
          <select
            value={form.sso_enabled}
            onChange={(e) => setForm({ ...form, sso_enabled: e.target.value })}
        ...
        <div>
          ...
          <input
            value={form.sso_entity_id}
            onChange={(e) => setForm({ ...form, sso_entity_id: e.target.value })}
            className="mt-1 w-full rounded-lg border border-border px-3 py-2 text-sm"
          />
        </div>
        <div>
          ...
          <input
            ...
            onChange={(e) => setForm({ ...form, sso_metadata_url: e.target.value })}
            className="mt-1 w-full rounded-lg border border-border px-3 py-2 text-sm"
          />
        </div>
        <button
