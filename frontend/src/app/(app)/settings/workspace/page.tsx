...
export default function WorkspaceSettingsPage() {
  ...
  if (isLoading)
    return (
      <div className="p-8 animate-pulse text-muted-foreground uppercase tracking-widest font-black text-xs">
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="page-header border-b border-border/10 pb-6">
        <div>
          ...
          <p className="page-description text-muted-foreground font-medium uppercase tracking-widest text-[10px] mt-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      />
                      <div className="absolute right-4 top-1/2 -translate-y-1/2 text-[10px] font-black text-muted-foreground/40 uppercase">
                        .crm.ai
                      </div>
                    </div>
                  ...
                  <div className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-3">
                        <div
                          className="w-11 h-11 rounded-xl border border-border/50"
              ...
              <div className="space-y-8">
                <div className="p-6 rounded-2xl bg-muted/10 border border-border/20 border-l-4 border-l-brand">
                  ...
                  <p className="text-[10px] text-muted-foreground uppercase tracking-widest leading-relaxed">
                    Point your CNAME records to{' '}
                    <code className="text-brand font-black">proxy.monster.fm</code> to enable custom
                    domain resolution for your CRM instance.
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-3">
                    <input
                      ...
                      onChange={(e) =>
                        setTenant(tenant ? { ...tenant, customDomain: e.target.value } : null)
                      }
                    />
        ...
        <div className="lg:col-span-1">
          <div className="rounded-2xl border border-border/30 bg-card/20 backdrop-blur-xl p-8 shadow-xl border-l-4 border-l-brand relative overflow-hidden group">
            ...
            <div className="space-y-8">
              <div
                className="p-4 rounded-xl border border-border/10 bg-background/50 border-t-4"
                style={{ borderTopColor: brandingForm.watch('primaryColor') }}
              >
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <p className="text-[10px] font-black uppercase tracking-tighter truncate max-w-[120px]">
                    {brandingForm.watch('companyName')}
                  </p>
                </div>
                <div className="h-2 w-full bg-muted/30 rounded-full mb-2" />
                <div className="h-2 w-2/3 bg-muted/30 rounded-full mb-6" />
                <div
                  className="h-8 w-full rounded-lg bg-current opacity-80"
