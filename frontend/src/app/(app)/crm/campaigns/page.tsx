  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case CampaignStatus.DRAFT:
        return 'bg-gray-100 dark:bg-white/10 text-gray-500 dark:text-gray-400 border-transparent';
      default:
                  ...
                  <td className="px-6 py-4">
                    <div className="space-y-1.5 min-w-[120px]">
                      <div className="flex items-center justify-between text-[10px] font-bold text-gray-500">
                        <span>
                          {c.totalLeads > 0
                            ? Math.round((c.completedLeads / c.totalLeads) * 100)
                            : 0}
                          %
                        </span>
                        <span>
                          {c.completedLeads}/{c.totalLeads}
                        </span>
                      </div>
                      <div className="h-1.5 w-full bg-gray-100 dark:bg-white/5 rounded-full overflow-hidden">
                        <motion.div
                          initial={{ width: 0 }}
                          animate={{
                            width: `${c.totalLeads > 0 ? (c.completedLeads / c.totalLeads) * 100 : 0}%`,
                          }}
          ...
          {campaigns.length === 0 && (
            <div className="py-20 text-center">
              <p className="text-gray-400 font-bold">
                No campaigns yet. Launch your first outreach!
              </p>
            </div>
          )}
        </div>
        ...
        {showUpload && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-xl bg-white dark:bg-card rounded-3xl shadow-2xl border border-gray-200 dark:border-border overflow-hidden p-8 space-y-6"
            >
