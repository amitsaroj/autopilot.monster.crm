    ...
    <div className="space-y-12 animate-in fade-in duration-1000 pb-20">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
        <div>
          ...
          <p className="text-gray-500 text-[11px] font-bold mt-1 uppercase tracking-[0.2em]">
            Longitudinal performance analysis and revenue trajectory
          </p>
        </div>
        <div className="flex gap-4">
          ...
          <button
            ...
            className="px-8 py-3 bg-indigo-600 hover:bg-indigo-500 text-white rounded-[24px] text-[10px] font-black uppercase tracking-widest transition-all shadow-2xl shadow-indigo-600/20 flex items-center gap-2"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {[
          ...
          <div
            key={i}
            className="p-8 rounded-[40px] bg-white/[0.02] border border-white/[0.05] hover:border-indigo-500/20 transition-all group relative overflow-hidden backdrop-blur-md shadow-soft"
          >
            ...
            <div className="flex justify-between items-start mb-6">
              ...
              <div
                className={cn(
                  ...
                  card.trend.startsWith('+') ? 'text-emerald-400' : 'text-rose-400',
                )}
              >
          ...
          <div className="flex justify-between items-center mb-10">
            <div>
              ...
              <p className="text-[9px] font-black text-gray-600 uppercase tracking-widest">
                Monthly conversion capitalization
              </p>
            </div>
            <div className="flex gap-2 p-1.5 rounded-2xl bg-white/[0.03] border border-white/5">
              {['6M', '1Y', 'ALL'].map((t) => (
                <button
                  key={t}
                  className="px-3 py-1 rounded-lg text-[8px] font-black bg-white/5 text-gray-500 hover:text-white transition-all uppercase"
                >
                  {t}
                </button>
              ))}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-1 p-10 rounded-[50px] bg-white/[0.02] border border-white/[0.05] shadow-2xl overflow-hidden relative">
          <h3 className="text-sm font-black text-white uppercase tracking-widest mb-10 text-center italic">
            ...
            {[
              ...
              <div key={i} className="group">
                <div className="flex justify-between items-end mb-3">
                  <span className="text-[11px] font-black text-white uppercase tracking-widest group-hover:text-indigo-400 transition-colors">
                    {source.name}
                  </span>
                ...
                <div className="h-3 w-full bg-white/5 rounded-full overflow-hidden border border-white/5 shadow-inner">
                  <div
                    className={cn(
                      'h-full rounded-full animate-in slide-in-from-left duration-1000 shadow-lg shadow-indigo-500/10',
                      source.color,
                    )}
