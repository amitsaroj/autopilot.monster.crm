      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1 uppercase tracking-widest font-bold">
            Monitor multi-channel engagement vectors and historical interaction logs
          </p>
        </div>
      </div>
          ...
          {filteredActivities.map((activity) => (
            ...
            >
              ...
              <div className="p-8 rounded-[40px] bg-white/[0.02] border border-white/[0.05] hover:border-emerald-500/10 transition-all relative overflow-hidden backdrop-blur-sm">
                ...
                <h3 className="text-xl font-black text-white uppercase tracking-tighter mb-2 group-hover:text-emerald-400 transition-all">
                  {activity.title}
                </h3>
                <p className="text-gray-500 text-sm font-medium leading-relaxed max-w-2xl">
                  {activity.description ||
                    'No descriptive metadata provided for this engagement vector.'}
                </p>
          ...
          {filteredActivities.length === 0 && (
            <div className="py-20 text-center">
              <p className="text-gray-500 font-black text-xs uppercase tracking-widest">
                No interaction intelligence detected in the stream.
              </p>
            </div>
          )}
        </div>
